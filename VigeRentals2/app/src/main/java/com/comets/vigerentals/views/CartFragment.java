...
import com.comets.vigerentals.adapters.CartListAdapter;
import com.comets.vigerentals.adapters.CartListAdapter;
import com.comets.vigerentals.databinding.FragmentCartBinding;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        fragmentCartBinding.placeOrderButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                navController.navigate(R.id.action_cartFragment4_to_orderFragment2);
            }
        });
